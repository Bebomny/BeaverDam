import type {PageServerLoad} from "../../../../.svelte-kit/types/src/routes/(public)/leaderboard/$types";
...
export const load: PageServerLoad = async ({ fetch, locals}) => {
    try {
        ...
        const response = await fetch(`${BACKEND_URL}/api/watchpost/latest?page=0&size=50`, {
            method: "GET",
            headers: {
